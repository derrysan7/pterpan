<?php
require_once $_SERVER['DOCUMENT_ROOT']."/pterpan/core/init.php";
...
if ( isset($_POST['submit']) ) {
  ...
  // filter_var($nominal_penghasilan,FILTER_VALIDATE_INT) && !empty($tanggal_penghasilan) ) {
    if ( insert_sallary($nama_penghasilan, $tanggal_penghasilan, $nominal_penghasilan) ) {
      ...
      $result = "<div class= 'alert alert-success'>Daftar pemasukan berhasil ditambahkan!</div>";
    }else {
      die("Gagal");
    }
  // }else {
...
require_once "/pterpan/views/header.php";
...
<div class="col-md-6">
  <form class="form-horizontal" action="add_sallary.php" method="post">
    ...
    <div class="form-group">
      <label class="col-sm-4 control-label" for="tanggal_penghasilan">Tanggal pemasukan</label>
      <div class="col-sm-8 input-group">
        <input class="form-control" id="datepicker" name="tanggal_penghasilan" type="text" required>
    ...
    <div class="form-group">
      <label class="col-sm-4 control-label" for="nama_penghasilan">Nama pemasukan</label>
      <div class="col-sm-8 input-group">
        <input class="form-control" name="nama_penghasilan" type="text" placeholder="Contoh: Gaji kantor" required>
        <span class="input-group-addon">
    ...
    <div class="form-group">
      <label class="col-sm-4 control-label" for="nominal_penghasilan">Nominal pemasukan</label>
      <div class="col-sm-8 input-group">
        <span class="input-group-addon">Rp</span>
        <input class="form-control" name="nominal_penghasilan" type="number"
